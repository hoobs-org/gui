                ...
                <div class="inner">
                    <svg viewBox="0 0 100 100">
                        <g v-if="locked">
                            ...
                            <path class="label" d="M40.9,73.7h1.5V79h2.7v1.4h-4.2V73.7z" />
                            <path class="label" d="M45.6,77c0-0.5,0.1-1,0.3-1.4c0.2-0.4,0.4-0.8,0.7-1.1c0.3-0.3,0.7-0.5,1.1-0.7c0.4-0.2,0.9-0.2,1.4-0.2 c0.5,0,1,0.1,1.4,0.2c0.4,0.2,0.8,0.4,1.1,0.7c0.3,
                            ...
                            <path class="label" d="M58.1,75.4c-0.1-0.2-0.3-0.3-0.5-0.4c-0.2-0.1-0.5-0.1-0.7-0.1s-0.5,0.1-0.8,0.2c-0.2,0.1-0.4,0.3-0.6,0.4 c-0.2,0.2-0.3,0.4-0.4,0.7s-0.1,0.5-0.1,0.9c0,0.3,
                            ...
                            <path class="label" d="M60.3,73.7h1.5v2.8l2.6-2.8h1.9l-3,3.1l3.2,3.6h-2.1l-2.7-3.2v3.2h-1.5V73.7z" />
                            <path class="label" d="M67.1,73.7h4.5v1.4h-3.1v1.2h2.9v1.4h-2.9V79h3.2v1.4h-4.7V73.7z" />
                            <path class="label" d="M72.9,73.7h2.2c0.5,0,1,0.1,1.5,0.2c0.5,0.1,0.9,0.3,1.3,0.6c0.4,0.3,0.6,0.6,0.9,1c0.2,0.4,0.3,0.9,0.3,1.6 c0,0.5-0.1,1-0.3,1.4c-0.2,0.4-0.5,0.8-0.8,1c-0.3,
                            ...
                            <circle class="label" cx="15.9" cy="77" r="11" v-on:click="toggle" style="cursor: pointer;" />
                        </g>
                        <g v-else>
                            ...
                            <circle class="label" cx="83.9" cy="77" r="11" v-on:click="toggle" style="cursor: pointer;" />
                        </g>
                    </svg>
                </div>
            </div>
        ...
        .lock {
            ...
            svg {
                ...
                .border {
                    ...
                    stroke: var(--application-input-accent);
                }
