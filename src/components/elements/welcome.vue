...
<template>
    <h2 id="welcome">
        <svg class= "logo" width="27" height="27" viewBox="0 0 80 80.92" xmlns="http://www.w3.org/2000/svg">
            <rect class="background" x="1.25" y="1.25" width="77" height="78" rx="16.3" />
            <path class="foreground" d="M17,44.62a3.78,3.78,0,0,0,5.56-.13q4.63-4.53,9.24-9.08c2.33-2.3,4.68-4.59,7-6.91.85-.84,1.52-.78,
